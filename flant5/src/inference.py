...
from src import BaseSBFModel, Model, gin_utils
from src.evaluation_utils import generic_evaluate_function
...
def predict(
    *,
    ...
    if os.path.exists(os.path.join(output_dir, "predictions.csv")):
        ...
        answer_df = pd.read_csv(os.path.join(output_dir, "predictions.csv"))
        ...
        answer_df.to_csv(os.path.join(output_dir, "predictions.csv"), index=False)
