...
#SBATCH --output=logs/few_shot_llm/comorbidity_llama_chat_7b_v2_gpt_prompt.log
#SBATCH --error=errors/few_shot_llm/comorbidity_llama_chat_7b_v2_gpt_prompt.err
