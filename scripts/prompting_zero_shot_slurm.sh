...
#SBATCH --output=logs/zero_shot_llm/zero_shot_depression_mental_flan_t5_v1.log
#SBATCH --error=errors/zero_shot_llm/zero_shot_depression_mental_flan_t5_v1.err
