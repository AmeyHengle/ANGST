...
#SBATCH --output=logs/zero_shot_llm/depression_llama_chat_7b_v2_gpt_prompt.log
#SBATCH --error=errors/zero_shot_llm/depression_llama_chat_7b_v2_gpt_prompt.err
